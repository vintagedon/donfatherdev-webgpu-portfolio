...
Date-based development history. Each work log captures what was done, what changed, what problems arose, and what comes next. Work logs are the project's execution record, complementing specs and charters with a concise account of what happened.
...
```
work-logs/
├── worklog-2026-05-18-repo-hydration-pass.md  # First repository hydration pass
└── README.md                          # This file
```
...
Naming: Date-primary by default: `worklog-YYYY-MM-DD.md` or `worklog-YYYY-MM-DD-brief-topic.md` when multiple logs share a date.
